...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h3 class="h3">Add a new Skill</h3>
    </div>
    <div id="content">
        <div class="alert alert-danger" style="display: <?= $errorVisibility ?>;"> <?= $errorString ?> </div>
        <form id="insertion-form" action="index.php?table=skill&action=store&event=create" method="POST">
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" class="form-control" id="name" name="name" aria-describedby="Name" placeholder="Write a name for the skill" value="<?= $_SESSION["formData"]["name"] ?? "" ?>" required>
            ...
            <div class="form-group">
                ...
                <select id="attribute-select" name="attribute">
                    <?php
                        // $currentType = $_SESSION["formData"]["type"] ?? "Stat Boost";
                        // switch($currentType){
                        //     case "Stat Boost":
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="value" name="value" placeholder="5" value="<?= $_SESSION["formData"]["value"] ?? 5 ?>" required>
            </div>
